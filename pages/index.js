...
import { Box, Button, Text, Heading, Container, Flex, Link } from "theme-ui";
  ...
  return (
    <Container>
      ...
      >
        ...
        <Fetcher mobileBrowser={() => mobileCheck()} />
        <Text sx={{ textAlign: "center", padding: [1, 2] }}>
          {mobileCheck()
            ? "Notifications are not currently supported on mobile browsers, sorry!"
            : ""}
        </Text>
      </Flex>
      <Flex
      ...
      >
        <Text>
          LFT Notifications is{" "}
          <Link href="https://github.com/MattieTK/lft.tk.gg">open source</Link>
        </Text>
        <Text>
